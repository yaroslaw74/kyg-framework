...
class GradientLineChart extends AbstractCharts
{
    protected string $script = 'gradient-chart';
    ...
    public function setForecastDataPoints(int $count): void
    {
        $this->options['forecastDataPoints'] = $count;
    }

    public function addDate(\DateTime $categories, int|float $data): void
    {
