...
use App\Modules\Classification\Repository\Translation\CategoryTranslationRepository;
...
{
    #[ORM\ManyToOne(targetEntity: ClassificationCategory::class, inversedBy: 'translations')]
