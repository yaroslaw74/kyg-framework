...
use App\Modules\Users\Form\Type\ChangePasswordFormType;
use App\Modules\Users\Form\Type\ResetPasswordRequestFormType;
...
/**
 * @see \App\Tests\Controller\ResetPasswordControllerTest
 */
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request): Response
    {
        ...
        return $this->render('@Users/reset_password/forgot.html.twig', [
            'requestForm' => $form,
        ]);
    }
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, ?string $token = null): Response|RedirectResponse
    {
        if (null !== $token) {
