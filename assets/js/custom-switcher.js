...
function switcherClick() {
    ...
    const ltrBtn = document.querySelector("#switcher-ltr");
    const rtlBtn = document.querySelector("#switcher-rtl");
    const verticalBtn = document.querySelector("#switcher-vertical");
    const horiBtn = document.querySelector("#switcher-horizontal");
    const boxedBtn = document.querySelector("#switcher-boxed");
    const fullwidthBtn = document.querySelector("#switcher-full-width");
    const fixedMenuBtn = document.querySelector("#switcher-menu-fixed");
    const scrollMenuBtn = document.querySelector("#switcher-menu-scroll");
    const fixedHeaderBtn = document.querySelector("#switcher-header-fixed");
    const scrollHeaderBtn = document.querySelector("#switcher-header-scroll");
    const lightHeaderBtn = document.querySelector("#switcher-header-light");
    const darkHeaderBtn = document.querySelector("#switcher-header-dark");
    const colorHeaderBtn = document.querySelector("#switcher-header-primary");
    const gradientHeaderBtn = document.querySelector("#switcher-header-gradient");
    const transparentHeaderBtn = document.querySelector("#switcher-header-transparent");
    const lightMenuBtn = document.querySelector("#switcher-menu-light");
    const darkMenuBtn = document.querySelector("#switcher-menu-dark");
    const colorMenuBtn = document.querySelector("#switcher-menu-primary");
    const gradientMenuBtn = document.querySelector("#switcher-menu-gradient");
    const transparentMenuBtn = document.querySelector("#switcher-menu-transparent");
    const regular = document.querySelector("#switcher-regular");
    const classic = document.querySelector("#switcher-classic");
    const modern = document.querySelector("#switcher-modern");
    const defaultBtn = document.querySelector("#switcher-default-menu");
    const menuClickBtn = document.querySelector("#switcher-menu-click");
    const menuHoverBtn = document.querySelector("#switcher-menu-hover");
    const iconClickBtn = document.querySelector("#switcher-icon-click");
    const iconHoverBtn = document.querySelector("#switcher-icon-hover");
    const closedBtn = document.querySelector("#switcher-closed-menu");
    const iconTextBtn = document.querySelector("#switcher-icontext-menu");
    const overlayBtn = document.querySelector("#switcher-icon-overlay");
    const doubleBtn = document.querySelector("#switcher-double-menu");
    const detachedBtn = document.querySelector("#switcher-detached");
    const resetBtn = document.querySelector("#resetbtn");
    const primaryDefaultColor1Btn = document.querySelector("#switcher-primary");
    const primaryDefaultColor2Btn = document.querySelector("#switcher-primary1");
    const primaryDefaultColor3Btn = document.querySelector("#switcher-primary2");
    const primaryDefaultColor4Btn = document.querySelector("#switcher-primary3");
    const primaryDefaultColor5Btn = document.querySelector("#switcher-primary4");
    const bgDefaultColor1Btn = document.querySelector("#switcher-background");
    const bgDefaultColor2Btn = document.querySelector("#switcher-background1");
    const bgDefaultColor3Btn = document.querySelector("#switcher-background2");
    const bgDefaultColor4Btn = document.querySelector("#switcher-background3");
    const bgDefaultColor5Btn = document.querySelector("#switcher-background4");
    const bgImage1Btn = document.querySelector("#switcher-bg-img");
    const bgImage2Btn = document.querySelector("#switcher-bg-img1");
    const bgImage3Btn = document.querySelector("#switcher-bg-img2");
    const bgImage4Btn = document.querySelector("#switcher-bg-img3");
    const bgImage5Btn = document.querySelector("#switcher-bg-img4");
    const ResetAll = document.querySelector("#reset-all");
    const loaderEnable = document.querySelector("#switcher-loader-enable");
    const loaderDisable = document.querySelector("#switcher-loader-disable");

    // primary theme
    const primaryColor1Var = primaryDefaultColor1Btn.addEventListener("click", () => {
        localStorage.setItem("primaryRGB", "58, 88, 146");
        html.style.setProperty("--primary-rgb", `58, 88, 146`);
        updateColors();
    });
    const primaryColor2Var = primaryDefaultColor2Btn.addEventListener("click", () => {
        localStorage.setItem("primaryRGB", "49, 176, 176");
        html.style.setProperty("--primary-rgb", `49, 176, 176`);
        updateColors();
    });
    const primaryColor3Var = primaryDefaultColor3Btn.addEventListener("click", () => {
        localStorage.setItem("primaryRGB", "170, 82, 216");
        html.style.setProperty("--primary-rgb", `170, 82, 216`);
        updateColors();
    });
    const primaryColor4Var = primaryDefaultColor4Btn.addEventListener("click", () => {
        localStorage.setItem("primaryRGB", "80, 198, 118");
        html.style.setProperty("--primary-rgb", `80, 198, 118`);
        updateColors();
    });
    const primaryColor5Var = primaryDefaultColor5Btn.addEventListener("click", () => {
    ...
    // Background theme
    const backgroundColor1Var = bgDefaultColor1Btn.addEventListener("click", () => {
    ...
    const backgroundColor2Var = bgDefaultColor2Btn.addEventListener("click", () => {
    ...
    const backgroundColor3Var = bgDefaultColor3Btn.addEventListener("click", () => {
    ...
    const backgroundColor4Var = bgDefaultColor4Btn.addEventListener("click", () => {
    ...
    const backgroundColor5Var = bgDefaultColor5Btn.addEventListener("click", () => {
    ...
    /* Dark Layout Start */
    const darkThemeVar = darkBtn.addEventListener("click", () => {
        darkFn();
    ...
    /* Light Menu Start */
    const lightMenuVar = lightMenuBtn.addEventListener("click", () => {
    ...
    /* Color Menu Start */
    const colorMenuVar = colorMenuBtn.addEventListener("click", () => {
    ...
    /* Dark Menu Start */
    const darkMenuVar = darkMenuBtn.addEventListener("click", () => {
        html.setAttribute("data-menu-styles", "dark");
        localStorage.setItem("valexMenu", "dark");
    });
    /* Dark Menu End */
    ...
    /* Gradient Menu Start */
    const gradientMenuVar = gradientMenuBtn.addEventListener("click", () => {
    ...
    const transparentMenuVar = transparentMenuBtn.addEventListener("click", () => {
    ...
    /* Light Header Start */
    const lightHeaderVar = lightHeaderBtn.addEventListener("click", () => {
    ...
    /* Color Header Start */
    const colorHeaderVar = colorHeaderBtn.addEventListener("click", () => {
    ...
    /* Dark Header Start */
    const darkHeaderVar = darkHeaderBtn.addEventListener("click", () => {
        html.setAttribute("data-header-styles", "dark");
        localStorage.setItem("valexHeader", "dark");
    });
    /* Dark Header End */
    ...
    const gradientHeaderVar = gradientHeaderBtn.addEventListener("click", () => {
    ...
    const transparentHeaderVar = transparentHeaderBtn.addEventListener("click", () => {
    ...
    const fullwidthVar = fullwidthBtn.addEventListener("click", () => {
    ...
    /* Boxed Layout Start */
    const boxedVar = boxedBtn.addEventListener("click", () => {
    ...
    const shadowVar = regular.addEventListener("click", () => {
    ...
    const noShadowVar = classic.addEventListener("click", () => {
    ...
    const modernVar = modern.addEventListener("click", () => {
    ...
    const fixedHeaderVar = fixedHeaderBtn.addEventListener("click", () => {
        html.setAttribute("data-header-position", "fixed");
        localStorage.setItem("valexHeaderfixed", true);
        localStorage.removeItem("valexHeaderscrollable");
    });

    const scrollHeaderVar = scrollHeaderBtn.addEventListener("click", () => {
    ...
    const fixedMenuVar = fixedMenuBtn.addEventListener("click", () => {
        html.setAttribute("data-menu-position", "fixed");
        localStorage.setItem("valexMenufixed", true);
        localStorage.removeItem("valexMenuscrollable");
    });

    const scrollMenuVar = scrollMenuBtn.addEventListener("click", () => {
    ...
    const defaultVar = defaultBtn.addEventListener("click", () => {
    ...
    const closedVar = closedBtn.addEventListener("click", () => {
        closedSidemenuFn();
    ...
    /* Hover Submenu Start */
    const detachedVar = detachedBtn.addEventListener("click", () => {
        detachedFn();
    ...
    const iconTextVar = iconTextBtn.addEventListener("click", () => {
        iconTextFn();
    ...
    const overlayVar = overlayBtn.addEventListener("click", () => {
        iconOverayFn();
    ...
    const doubleVar = doubleBtn.addEventListener("click", () => {
        doubletFn();
    ...
    const menuClickVar = menuClickBtn.addEventListener("click", () => {
    ...
    const menuhoverVar = menuHoverBtn.addEventListener("click", () => {
        html.removeAttribute("data-vertical-style");
        menuhoverFn();
    ...
    const iconClickVar = iconClickBtn.addEventListener("click", () => {
        html.removeAttribute("data-vertical-style");
        iconClickFn();
    ...
    const iconhoverVar = iconHoverBtn.addEventListener("click", () => {
        html.removeAttribute("data-vertical-style");
        iconHoverFn();
    ...
    /* Sidemenu start*/
    const verticalVar = verticalBtn.addEventListener("click", () => {
    ...
    /* horizontal start*/
    const horiVar = horiBtn.addEventListener("click", () => {
        const mainContent = document.querySelector(".main-content");
        html.removeAttribute("data-vertical-style");
        //    local storage
    ...
    /* rtl start */
    const rtlVar = rtlBtn.addEventListener("click", () => {
    ...
    /* ltr start */
    const ltrVar = ltrBtn.addEventListener("click", () => {
        //    local storage
    ...
    // reset all start
    const resetVar = ResetAll.addEventListener("click", () => {
        ResetAllFn();
        setNavActive();
