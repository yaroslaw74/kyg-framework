...
function switcherClick() {
    let html = document.querySelector("html");
    let lightBtn = document.querySelector("#switcher-light-theme");
    let darkBtn = document.querySelector("#switcher-dark-theme");
    let ltrBtn = document.querySelector("#switcher-ltr");
    let rtlBtn = document.querySelector("#switcher-rtl");
    let verticalBtn = document.querySelector("#switcher-vertical");
    let horiBtn = document.querySelector("#switcher-horizontal");
    let boxedBtn = document.querySelector("#switcher-boxed");
    let fullwidthBtn = document.querySelector("#switcher-full-width");
    let fixedMenuBtn = document.querySelector("#switcher-menu-fixed");
    let scrollMenuBtn = document.querySelector("#switcher-menu-scroll");
    let fixedHeaderBtn = document.querySelector("#switcher-header-fixed");
    let scrollHeaderBtn = document.querySelector("#switcher-header-scroll");
    let lightHeaderBtn = document.querySelector("#switcher-header-light");
    let darkHeaderBtn = document.querySelector("#switcher-header-dark");
    let colorHeaderBtn = document.querySelector("#switcher-header-primary");
    let gradientHeaderBtn = document.querySelector("#switcher-header-gradient");
    let transparentHeaderBtn = document.querySelector("#switcher-header-transparent");
    let lightMenuBtn = document.querySelector("#switcher-menu-light");
    let darkMenuBtn = document.querySelector("#switcher-menu-dark");
    let colorMenuBtn = document.querySelector("#switcher-menu-primary");
    let gradientMenuBtn = document.querySelector("#switcher-menu-gradient");
    let transparentMenuBtn = document.querySelector("#switcher-menu-transparent");
    let regular = document.querySelector("#switcher-regular");
    let classic = document.querySelector("#switcher-classic");
    let modern = document.querySelector("#switcher-modern");
    let defaultBtn = document.querySelector("#switcher-default-menu");
    let menuClickBtn = document.querySelector("#switcher-menu-click");
    let menuHoverBtn = document.querySelector("#switcher-menu-hover");
    let iconClickBtn = document.querySelector("#switcher-icon-click");
    let iconHoverBtn = document.querySelector("#switcher-icon-hover");
    let closedBtn = document.querySelector("#switcher-closed-menu");
    let iconTextBtn = document.querySelector("#switcher-icontext-menu");
    let overlayBtn = document.querySelector("#switcher-icon-overlay");
    let doubleBtn = document.querySelector("#switcher-double-menu");
    let detachedBtn = document.querySelector("#switcher-detached");
    let resetBtn = document.querySelector("#resetbtn");
    let primaryDefaultColor1Btn = document.querySelector("#switcher-primary");
    let primaryDefaultColor2Btn = document.querySelector("#switcher-primary1");
    let primaryDefaultColor3Btn = document.querySelector("#switcher-primary2");
    let primaryDefaultColor4Btn = document.querySelector("#switcher-primary3");
    let primaryDefaultColor5Btn = document.querySelector("#switcher-primary4");
    let bgDefaultColor1Btn = document.querySelector("#switcher-background");
    let bgDefaultColor2Btn = document.querySelector("#switcher-background1");
    let bgDefaultColor3Btn = document.querySelector("#switcher-background2");
    let bgDefaultColor4Btn = document.querySelector("#switcher-background3");
    let bgDefaultColor5Btn = document.querySelector("#switcher-background4");
    let bgImage1Btn = document.querySelector("#switcher-bg-img");
    let bgImage2Btn = document.querySelector("#switcher-bg-img1");
    let bgImage3Btn = document.querySelector("#switcher-bg-img2");
    let bgImage4Btn = document.querySelector("#switcher-bg-img3");
    let bgImage5Btn = document.querySelector("#switcher-bg-img4");
    let ResetAll = document.querySelector("#reset-all");
    let loaderEnable = document.querySelector("#switcher-loader-enable");
    let loaderDisable = document.querySelector("#switcher-loader-disable");
